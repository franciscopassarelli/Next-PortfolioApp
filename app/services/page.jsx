...
function ServicesPage() {
  return (
    ...
    <img src="https://avatars.githubusercontent.com/u/118229728?v=4" alt="Tu imagen" class="imagen-pequeña"/>
        <h1>Hola 👋, Soy Francisco Nicolás Passarelli</h1>
        </div>
    ...
    <ul>
        ...
        <li>🚀 Estudiante en <strong>Coderhouse. Desarrollo Front-End React y NEXT JS / también tirando hacia el área de Testing QA Manual.</strong></li>
        <li>🤝 Estoy disponible para <strong>Aceptar oportunidades laborales en el mercado de IT, adaptándome y aprendiendo nuevas tecnologías.</strong></li>
...
Me gustaría compartir áreas de trabajo con personas aportando mis valores.</li>
    ...
    <p>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgf5GvxhVHYUqV9roWJ4I4xyszcLCUHxRpxXKfx6R-5gSQuxrApw2QADJwvxF6OLnM810&usqp=CAU" alt="franciscopassarelli.github.io/Miportafolio/" height="30" width="30"/>
        <a href="https://github.com/franciscopassarelli" target="_blank">Visitar mi Github</a>
    </p>

    <p>
        <img src="https://w7.pngwing.com/pngs/555/1002/png-transparent-computer-icons-linkedin-resume-curriculum-vitae-social-media-social-media-template-text-rectangle.png" alt="https://www.linkedin.com/in/franciscopassarelli/" height="30" width="30"/>
